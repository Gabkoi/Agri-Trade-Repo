...
const EditProfileScreen = () => {
    ...
    const [firstName, setFirstName] = useState("Gabrie");
    const [lastName, setLastName] = useState("Akoi");
    ...
    return (
        <KeyboardAvoidingView behavior='padding'
            keyboardVerticalOffset={Platform.OS === 'ios' ? 50 : 70} // comment this line to see this screen on the web
